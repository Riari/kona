...
namespace Kona
{
    internal class GlobalHotKeys : IDisposable
    {
        ...
        public static bool Register(string aKeyGestureString, Action aAction)
        {
            var c = new KeyGestureConverter();
            KeyGesture aKeyGesture = (KeyGesture)c.ConvertFrom(aKeyGestureString);
            return Register(aKeyGesture.Modifiers, aKeyGesture.Key, aAction);
        }

        public static bool Register(ModifierKeys aModifier, Key aKey, Action aAction)
        {
